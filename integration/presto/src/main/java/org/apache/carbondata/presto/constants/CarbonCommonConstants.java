...
public final class CarbonCommonConstants {
   ...
   * MEMBER_DEFAULT_VAL
   */
  private static final String MEMBER_DEFAULT_VAL = "@NU#LL$!";
   ...
   * FACT_FILE_EXT
   */
  private static final String FACT_FILE_EXT = ".carbondata";
   ...
   */
  @CarbonProperty
  public static final String PRESERVE_LATEST_SEGMENTS_NUMBER =
